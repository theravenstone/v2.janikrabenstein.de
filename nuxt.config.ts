    ...
    app: {
        ...
        head: {
            ...
            meta: [
                ...
                { name: 'description', content: 'Dein Webentwickler aus dem Landkreis Bayreuth. Lass uns gemeinsam das nächste Projekt starten!' },
                { name: 'og:description', content: 'Dein Webentwickler aus dem Landkreis Bayreuth. Lass uns gemeinsam das nächste Projekt starten!' },
                { name: 'twitter:description', content: 'Dein Webentwickler aus dem Landkreis Bayreuth. Lass uns gemeinsam das nächste Projekt starten!' },
