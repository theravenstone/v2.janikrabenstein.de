<template>
  <section class="p-6 lg:h-screen flex lg:mt-0">
    ...
    <div class="hidden lg:block">
      ...
      <i id="circle"
        class="fa-brands fa-php text-primary absolute w-24 h-24 bottom-3/4 left-1/3 animate-movecircle"></i>
      <a rel="noopener" target="_blank" href="https://github.com/theravenstone" title="GitHub">
        <i id="github"
          class="fa-brands fa-github text-primary hover:text-primary-hover transition duration-300 absolute w-16 h-16 top-1/3"></i>
      </a>
      ...
      <a rel="noopener noreferrer" target="_blank" href="https://discord.com/users/594922360553865216" title="Discord">
        <i id="discord"
          class="fa-brands fa-discord text-primary hover:text-primary-hover transition duration-300 absolute w-16 h-16 left-3/4 top-1/4"></i>
      </a>
    </div>
  </section>
</template>
