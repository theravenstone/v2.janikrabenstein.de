<template>
    <section class="container mx-auto p-6 mb-12">
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
            <div class="border-2 border-primary bg-primary/10 p-6 rounded-lg">
                <h3>Programmiersprachen</h3>
                <nav class="flex flex-col sm:items-start sm:text-left text-center items-center -mb-1 space-y-2.5">
                    <div>
                        <i class="fa-brands fa-python mr-3 w-6"></i>
                        <span>Python</span>
                    </div>
                    <div>
                        <i class="fa-brands fa-php mr-3 w-6"></i>
                        <span>PHP</span>
                    </div>
                    <div>
                        <i class="fa-brands fa-js-square mr-3 w-6"></i>
                        <span>JavaScript</span>
                    </div>
                    <div>
                        <i class="fa-brands fa-html5 mr-3 w-6"></i>
                        <span>HTML</span>
                    </div>
                    <div>
                        <i class="fa-brands fa-css3 mr-3 w-6"></i>
                        <span>CSS</span>
                    </div>
                </nav>
            </div>
            <div class="border-2 border-primary bg-primary/10 p-6 rounded-lg">
                ...
                <nav class="flex flex-col sm:items-start sm:text-left text-center items-center -mb-1 space-y-2.5">
                    <div>
                        <i class="fa-brands fa-vuejs mr-3 w-6"></i>
                        <span>Vue.js</span>
                    </div>
                    <div>
                        <span
